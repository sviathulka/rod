...
// Doc for environment variables: https://pkg.go.dev/github.com/sviathulka/rod/lib/defaults
...
// List of cdp API: https://github.com/sviathulka/rod/tree/main/lib/proto
...
func Example_load_extension() {
	...
	u := launcher.New().
		...
		// You can use XVFB to get rid of it: https://github.com/sviathulka/rod/blob/main/lib/examples/launch-managed/main.go
		Headless(false).
		MustLaunch()
